...
const TOKENS = [
  { id: "xGOV", name: "xGOV", addr: process.env.NEXT_PUBLIC_GOV_TOKEN as Address, desc: "Governance token" },
  { id: "xNOBT", name: "xNOBT", addr: process.env.NEXT_PUBLIC_XNOBT as Address, desc: "Testnet NOBT" },
  { id: "xBRT", name: "xBRT", addr: process.env.NEXT_PUBLIC_XBRT as Address, desc: "Testnet Broiler" },
  { id: "USDC", name: "USDC", addr: process.env.NEXT_PUBLIC_MOCK_USDC as Address, desc: "Mock USD Coin" },
  { id: "USDT", name: "USDT", addr: process.env.NEXT_PUBLIC_MOCK_USDT as Address, desc: "Mock Tether USD" },
