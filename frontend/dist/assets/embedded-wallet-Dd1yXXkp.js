import{A as e,B as t,C as n,H as r,P as i,Y as a,_ as o,g as s,i as c,j as l,l as ee,ot as u,r as d,t as f,v as p,y as m,z as h}from"./ModalController-3VDhtt85.js";import{_ as g,c as _,f as v,l as y,m as b,o as te,s as x,w as S,x as C,y as w}from"./wui-text-CHKS2txf.js";import{n as T,t as E}from"./ref-ClpsYMwB.js";import{g as D,l as O,t as k}from"./index-_WWOBk7h.js";var A=S`
  div {
    width: 100%;
  }
...
`,L=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},R={sm:`md-regular`,md:`lg-regular`,lg:`lg-regular`},ne={success:`sealCheck`,error:`warning`,warning:`exclamationCircle`},z=class extends w{constructor(){super(...arguments),this.type=`success`,this.size=`md`,this.imageSrc=void 0,this.disabled=!1,this.href=``,this.text=void 0}render(){return C`
      <a
        rel="noreferrer"
        target="_blank"
        href=${this.href}
    ...
    `}};V=B([y(`w3m-upgrade-wallet-view`)],V);var H=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},U=class extends w{constructor(){super(...arguments),this.loading=!1,this.switched=!1,this.text=``,this.network=d.state.activeCaipNetwork}render(){return C`
...
`,Z=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Q=class extends w{constructor(){super(),this.formRef=E(),this.usubscribe=[],this.name=``,this.error=``,this.loading=O.state.loading,this.suggestions=O.state.suggestions,this.profileName=d.getAccountData()?.profileName,this.onDebouncedNameInputChange=t.debounce(e=>{e.length<4?this.error=`Name must be at least 4 characters long`:k.isValidReownName(e)?(this.error=``,O.getSuggestions(e)):this.error=`The value is not a valid username`}),this.usubscribe.push(O.subscribe(e=>{this.suggestions=e.suggestions,this.loading=e.loading}),d.subscribeChainProp(`accountState`,e=>{this.profileName=e?.profileName,e?.profileName&&(this.error=`You already own a name`)}))}firstUpdated(){this.formRef.value?.addEventListener(`keydown`,this.onEnterKey.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.usubscribe.forEach(e=>e()),this.formRef.value?.removeEventListener(`keydown`,this.onEnterKey.bind(this))}render(){return C`
    ...
    `}submitButtonTemplate(){let e=this.suggestions.find(e=>e.name?.split(`.`)?.[0]===this.name&&e.registered);if(this.loading)return C`<wui-loading-spinner
        ...
        color="secondary"
      ></wui-loading-spinner>`;let t=`${this.name}${u.WC_NAME_SUFFIX}`;return C`
      <wui-icon-link
        ?disabled=${!!e}
    ...
    </wui-flex>`}isAllowedToSubmit(e){let t=e.split(`.`)?.[0],n=this.suggestions.find(e=>e.name?.split(`.`)?.[0]===t&&e.registered);return!this.loading&&!this.error&&!this.profileName&&t&&O.validateName(t)&&!n}async onSubmitName(r){try{if(!this.isAllowedToSubmit(r))return;n.sendEvent({type:`track`,event:`REGISTER_NAME_INITIATED`,properties:{isSmartAccount:s(d.state.activeChain)===h.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:r}}),await O.registerName(r),n.sendEvent({type:`track`,event:`REGISTER_NAME_SUCCESS`,properties:{isSmartAccount:s(d.state.activeChain)===h.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:r}})}catch(i){e.showError(i.message),n.sendEvent({type:`track`,event:`REGISTER_NAME_ERROR`,properties:{isSmartAccount:s(d.state.activeChain)===h.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:r,error:t.parseError(i)}})}}onEnterKey(e){if(e.key===`Enter`&&this.name&&this.isAllowedToSubmit(this.name)){let e=`${this.name}${u.WC_NAME_SUFFIX}`;this.onSubmitName(e)}}};Q.styles=X,Z([_()],Q.prototype,`errorMessage`,void 0),Z([x()],Q.prototype,`name`,void 0),Z([x()],Q.prototype,`error`,void 0),Z([x()],Q.prototype,`loading`,void 0),Z([x()],Q.prototype,`suggestions`,void 0),Z([x()],Q.prototype,`profileName`,void 0),Q=Z([y(`w3m-register-account-name-view`)],Q);var re=S`
...
`,ie=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},$=class extends w{render(){return C`
      ...
      >
        ...
        <wui-link
          @click=${()=>{t.openHref(D.URLS.FAQ,`_blank`)}}
        >
          Learn more
