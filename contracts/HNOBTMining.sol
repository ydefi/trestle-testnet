...
/**
 * @title HNOBTMining - BroilerPlus LP Staking with 5% tax
 * @dev Staking contract for BroilerPlus (BRT) LP tokens
 *      Supports 3-month, 6-month, and 12-month lock periods
 *      5% tax on reward transfers - grossed up for users
 */
contract HNOBTMining is AccessControl, ReentrancyGuard {
    ...
    IERC20 public immutable stakingToken;   // BRT/WMATIC LP
    IERC20 public immutable rewardToken;    // BRG Governance Token (5% tax)
